...
function fixCommonIssues(filePath) {
  ...
  if (content.includes('error.message') && !content.includes('interface ErrorWithMessage')) {
...
console.log('✅ Basic fixes applied. Run npm run lint to check remaining issues.');
